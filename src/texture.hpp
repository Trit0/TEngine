...
namespace te {
    ...
    public:
        ...
        Texture(Device &device, std::array<std::string, 6> textureFilePaths);
        Texture(
                Device &device,
                VkFormat format,
                VkExtent3D extent,
        ...
        static std::unique_ptr<Texture> createTextureFromFiles(Device & device, std::array<std::string, 6> textureFilePaths);
    ...
    private:
        ...
        void createTextureImageCubeMap(std::array<std::string, 6> &textureFilePaths);
        void createTextureImageViewCubeMap(VkImageViewType viewType);
